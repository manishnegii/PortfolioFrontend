  ...
  return (
    <SectionFrame ref = {sectionRef} theme="olive" id="cover" dataTestId="section-cover">
      ...
      <div className="mt-16 lg:mt-24 grid grid-cols-1 sm:grid-cols-3 gap-8 sm:gap-6">
        ...
        <ContactItem label="LinkedIn" value="linkedin.com/in/manish-negi" href="https://www.linkedin.com/in/manish-negi-587b12414" testId="cover-linkedin" onCopy={copyToClipboard}/>
